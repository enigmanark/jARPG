...
public class ExploreAndReturn extends Quest {
	...
	public ExploreAndReturn(int id) {
		super(id, QuestsType.ExploreAndReturn);
	}
	
	@Override
	public void post(Evermore game, Event e) {
		//TODO properly make ExploreAndReturn quest
		if(e instanceof MapChange) {
			...
			if(mapExplored){
				...
				if(questGiver.getName().equals(o.object.getName())){
					turnIn(game);
				}
			}
		}
